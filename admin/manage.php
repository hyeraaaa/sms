...
<body>
    ...
    <main>
        <div class="container-fluid pt-5 m-0">
            <div class="row">
                <!-- Left sidebar -->
                <div class="col-2 sidebars sidebar-left d-none d-xxl-block">
                    <div class="sticky-sidebar pt-5 m-0">
                        <div class="sidebar">
                            <div class="left-card">
                                <div class="d-flex flex-column">
                                    <a href="admin.php" class="btn nav-btn mb-3"><i class="bi bi-house"></i> Home</a>
                                    <a class="btn active nav-btn mb-3" href="manage.php"><i class="bi bi-kanban"></i> Manage Post</a>
                ...
                <!-- Main content area -->
                <div class="col-12 col-xxl-10 pt-4 d-flex justify-content-center">
                    <div class="row g-0 w-100">
                        <!-- Cover photo section -->
                        <div class="col-12 cover-photo-container-main d-flex justify-content-center">
                            <div class="cover-photo-container">
                                <div class="cover-photo-img">
                                    <img class="cover-photo img-fluid" src="img/cover photo test.jpg" alt="">
                                </div>

                                <div class="profile-photo-container d-flex align-items-center mt-5">
                                    <img src="img/test pic.jpg" alt="">
                                    <h5 class="ms-1 mt-xxl-5 mt-xl-5 mt-lg-5 mt-md-5 mt-sm-0">Joshua Andrei</h5>
                                </div>

                                <div class="profile-photo-container-md d-flex flex-row align-items-center mt-5">
                                    <img src="img/test pic.jpg" alt="">
                                    <h5 class="ms-1 mt-2">Joshua Andrei</h5>
                                </div>
                            </div>
                        ...
                        <!-- Feed Container -->
                        <div class="col-12 col-lg-8 main-content px-3">
                            <div class="feed-container justify-content-end">
                                <?php
                        ...
                        <!-- Info card -->
                        <div class="col-12 col-lg-4 info-card d-none d-lg-block">
